                    ...
                    <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:shadow-xl hover:scale-105">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <Link to="/gallery" className='text-white no-underline'>
                                <button className="mt-2 px-6 py-2 border-2 border-blue-400 text-white bg-blue-600 rounded-full hover:bg-gray-200 hover:text-blue-500 transition-all duration-300 cursor-pointer">
                                    Learn More
                                </button>
                            </Link>
                        </div>
